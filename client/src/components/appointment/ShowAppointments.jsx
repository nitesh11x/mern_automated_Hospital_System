        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
          <div>
            ...
            <p className="text-slate-500 text-sm">
              Manage clinical schedules and payments
            </p>
          </div>
          <button
            ...
            <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center p-4 z-50">
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-3 mb-6">
                  ...
                  <button
                    onClick={() =>
                      handlePaymentUpdate(payingApp._id, "Pending")
                    }
          ...
          {editingApp && (
            <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center p-4 z-50">
              ...
              >
                ...
                <p className="text-sm text-slate-500 mb-6">
                  Adjust date and time for {editingApp.name}
                </p>
                <div className="space-y-4 mb-8">
                  <div>
                    ...
                    <input
                      ...
                      value={
                        editingApp.appointmentDate
                          ? editingApp.appointmentDate.split("T")[0]
                          : ""
                      }
                      onChange={(e) =>
                        setEditingApp({
                ...
                <div className="flex gap-3">
                  <button
                    ...
                    className="flex-1 py-2.5 text-sm font-medium text-slate-600 hover:bg-slate-50 rounded transition-colors"
                  >
                    Cancel
                  </button>
                  <button
                    onClick={handleEditAppointment}
                    className="flex-1 py-2.5 bg-indigo-600 text-white text-sm font-bold rounded hover:bg-indigo-700 shadow-md transition-all"
                  >
                    Save Changes
                  </button>
                </div>
