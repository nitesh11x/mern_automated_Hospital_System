...
const OtpForm = () => {
  ...
  const verifyOtp = async () => {
    ...
    try {
      await dispatch(
        verifyOtpThunk({ email: storedEmail, otp: finalOtp }),
      ).unwrap();
    ...
    <div className="min-h-screen flex items-center justify-center bg-[#FBFBFF] px-6 font-sans">
      ...
      >
        ...
        <p className="text-slate-400 text-[11px] font-black uppercase tracking-widest leading-loose mb-10">
          Enter your registered email to receive a 6-digit authentication
          sequence.
        </p>
        ...
        <form onSubmit={handleSendOtp} className="space-y-8">
          ...
          <div className="text-center pt-8 border-t border-slate-50 text-[10px] font-black uppercase tracking-widest text-slate-400">
            ...
            <Link
              to="/patient/login"
              className="text-indigo-600 ml-2 hover:text-slate-900"
            >
              Return to Login
            </Link>
          </div>
            ...
            >
              ...
              <div className="text-center">
                ...
                <button
                  onClick={verifyOtp}
                  disabled={loading}
                  className="w-full bg-indigo-600 text-white py-6 rounded-sm font-black uppercase tracking-[0.3em] text-[11px] mb-6 shadow-lg shadow-indigo-600/20 hover:bg-slate-900 transition-all"
                >
                ...
                <button
                  ...
                  className="flex items-center justify-center gap-2 mx-auto text-[9px] font-black uppercase tracking-[0.2em] text-slate-400 hover:text-indigo-600 transition-colors"
                >
