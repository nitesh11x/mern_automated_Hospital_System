      ...
      >
        ...
        <div className="relative z-10 max-w-lg">
          ...
          <p className="text-indigo-50 text-lg font-medium max-w-sm leading-relaxed border-l-4 border-indigo-300 pl-6">
            Secure access to your personal health records, appointments, and
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-end px-1">
                ...
                <a
                  href="#"
                  className="text-[9px] font-bold text-indigo-600 uppercase tracking-widest hover:text-indigo-800"
                >
                  Recovery?
                </a>
              </div>
